...
### v4.4 (06.11.2025) 🎯
**שיפור:** זיהוי דינמי של תבניות תעודות + הסברה משופרת ל-LLM

**מה חדש:**
- ✨ פונקציה חדשה: `detectDocumentPatterns()` (שורות 451-511)
- 🔍 זיהוי אוטומטי של תבנית BOOKNUM מה-OCR (107/108XXXXXX)
- 📚 הנחיות מותאמות אישית ל-LLM עם דוגמאות קונקרטיות
- 🎯 לוג מפורט: `✨ זוהתה תבנית BOOKNUM: 108XXXXXX (3 דוגמאות: ...)`

**שיפורים ב-technical_config:**
```javascript
documents: {
  search_in: [{
    pattern: "\\b(108\\d{6})\\b",  // דינמי לפי מה שנמצא ב-OCR
    description: "BOOKNUM - זוהה 108XXXXXX (3 דוגמאות מה-OCR)",
    detected_examples: ["108187003", "108187002", "108432318"]
  }]
}
```

**שיפורים ב-llm_prompt:**
- לפני: "זהה תעודות (DOCNO/BOOKNUM) - חפש מספרים בפורמט 25XXXXXX או 108XXXXXX"
- אחרי: "זהה תעודות (DOCNO/BOOKNUM) - זוהו 3 מספרי BOOKNUM בפורמט 108XXXXXX (דוגמאות: 108187003, 108187002, 108432318). חפש מספרים אלו בטקסט והתאם עם docs_list"

**יתרונות:**
- ✅ LLM מקבל הנחיות ספציפיות לחשבונית הנוכחית
- ✅ תבנית regex מדויקת יותר
- ✅ דוגמאות קונקרטיות מהחשבונית עצמה

### v4.3 (05.11.2025)
**שיפור:** Fallback לחיפוש רכבים ב-AZURE_TEXT + מניעת זיהוי מספרי כרטיס

### v4.2 (31.10.2025)
**גרסה ראשונית** - תיקון חישוב מחיר + תמיכה מלאה ב-UnidentifiedNumbers
